...
handleNovoMembro = () => {
  ...
  render() {
    ...
    return (
      ...
      <Item body bordered >
      <Button block light style={{color:'black',backgroundColor:'#0000EE',width:'100%'}} onPress={() => this.handleNovoMembro()}>
...
<FlatList
  ...
  return (
    ...
    <Button block light style={{color:'black',backgroundColor:'#0000EE',width:'75%'}}  >
