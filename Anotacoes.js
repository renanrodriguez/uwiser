...
static navigationOptions = {
  ...
  render() {
    ...
    return (
      ...
      <Item>
        <Button block light style={{color:'black',backgroundColor:'#0000EE',width:'60%'}}  onPress={this.handleCadastroTarefa}>
        ...
        <Button block light style={{color:'black',backgroundColor:'#00ced1',width:'20%'}} >
